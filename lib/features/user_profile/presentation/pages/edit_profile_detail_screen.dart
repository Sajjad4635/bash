...
class EditProfileDetailScreen extends StatefulWidget {
  ...
  EditProfileDetailScreen({required this.name, required this.lastName, required this.shopName, required this.address, required this.mobile, required this.email, Key? key}) : super(key: key);

  @override
  State<EditProfileDetailScreen> createState() => _EditProfileDetailScreenState();
}
        ...
        child: BlocListener<ProfileBloc, ProfileState>(
          listener: (context, state) {
            ...
            if (state is UserProfileUpdated) {
              ShowSnackBar().showSuccessMessage(context: context, message: 'ویرایش با موفقیت انجام شد.');
